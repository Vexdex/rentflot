...
<?php include dirname(__FILE__).'/fieldsConfiguration.php' ?>
  ...
  // Переопределяем метод лля вывода лейблов без хуманайза
  ...
  // Переопределяем метод лля вывода лейблов без хуманайза в акшинах
  protected function fixActionParameters($action, $parameters)
  {
    ...
    // Если в начале строки label стоит спецзнак (_) то выводим без хуманайза =)
