 ...
 */
class sfWidgetFormSpan extends sfWidgetForm
{
  /**
   * Constructor.
   *
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('template', '%span% %empty_checkbox% %empty_label%');
  }
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    return strtr($this->getOption('template'), array(
      '%span%'    => $this->renderContentTag('span', format_datetime($value, 'dd.MM.yyyy HH:mm'), array('class' => 'InputText')),                                 
