 ...
 */
class sfWidgetFormMagicJQueryDate extends sfWidgetForm
{
  /**
  ...
  {
		$this->addOption('image', '/magicLibsPlugin/images/datepicker.png');
...
<script type="text/javascript">
  ...
  {
		var date_value = jQuery("#%s").val();
		var d = date_value.split('.');
		jQuery("#%s").val(parseInt(d[2], 10) + '-' + parseInt(d[1], 10) + '-' + parseInt(d[0], 10));
    return {};
  }
...
EOF
      ...
      $prefix, 
      $prefix, 
      sfContext::getInstance()->getI18n()->__('choose_date', null, 'grid'),
      $image, 
