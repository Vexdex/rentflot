...
/**
 * KitchenTranslation form base class.
 *
 * @method KitchenTranslation getObject() Returns the current form's model object
 *
 * @package    Rentflot
 * @subpackage form
 * @author     Infosoft
 ...
 */
abstract class BaseKitchenTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('kitchen_translation[%s]');
