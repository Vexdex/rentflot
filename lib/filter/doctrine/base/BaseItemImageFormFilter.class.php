...
/**
 * ItemImage filter form base class.
 *
 * @package    Rentflot
 * @subpackage filter
 * @author     Infosoft
 ...
 */
abstract class BaseItemImageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'object_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Item'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('item_image_filters[%s]');
