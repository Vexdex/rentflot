...
/**
 * CategoryItem filter form base class.
 *
 * @package    Rentflot
 * @subpackage filter
 * @author     Infosoft
 ...
 */
abstract class BaseCategoryItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('category_item_filters[%s]');
